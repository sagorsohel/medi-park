                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="md:w-2/3 p-8 md:p-12">
                            ...
                            <div className="space-y-6 text-gray-600 leading-relaxed mt-8 text-justify">
                                ...
                                <p>
                                    At <span className="font-semibold text-[#10b981]">Bangladesh Specialized Hospital PLC.</span>, we value leadership and dedication.
                                </p>

                                <div className="pt-8 mt-8 border-t border-gray-100">
                                    <h3 className="text-xl font-bold text-[#1e3a8a]">{director.name}</h3>
                                    <p className="text-[#10b981] font-medium">{director.title}</p>
                                </div>
                            </div>
                        </div>
                    </div>
