...
import { Plus, Search, Edit2, Trash2, Loader2, FileText } from "lucide-react";
...
export default function PackagePagesPage() {
    ...
    const { data, isLoading } = useGetPackagePagesQuery(currentPage);
    const [deletePackage] = useDeletePackagePageMutation();
    const [updatePackage] = useUpdatePackagePageMutation();
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            toast.success("Package page deleted successfully");
        } catch (error) {
            toast.error("Failed to delete package page");
        } finally {
    ...
    const filteredData = data?.data.filter((pkg) =>
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Package Pages</h1>
                    <p className="text-gray-500">Manage all package documentation pages</p>
                </div>
                <Link to="/admin/package-pages/new">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                ...
                {isLoading ? (
                    <div className="py-20 flex flex-col items-center gap-4">
                        ...
                        <p className="text-gray-400 font-medium">Loading pages...</p>
                    </div>
                    ...
                    <div className="py-20 flex flex-col items-center gap-4 text-center">
                        ...
                        <p className="text-gray-500 max-w-sm">
                            You haven't added any package pages yet, or none match your search criteria.
                        </p>
                    </div>
                ) : (
                        ...
                        <Table>
                            <TableHeader className="bg-gray-50/80">
                                <TableRow>
                                    ...
                                    <TableHead className="font-bold py-5">Notice</TableHead>
                            ...
                            <TableBody>
                                {filteredData?.map((pkg) => (
                                    <TableRow key={pkg.id} className="hover:bg-gray-50/50 transition-colors group">
                                        ...
                                        <TableCell>
                                            <span className="text-gray-500 line-clamp-2 max-w-xs block">
                                                {pkg.notice || "No notice provided"}
                                            </span>
                                        </TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell className="text-right">
                                            <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <Link to={`/admin/package-pages/edit/${pkg.id}`}>
                                                    <Button
                                                        variant="ghost"
                                                        size="icon"
