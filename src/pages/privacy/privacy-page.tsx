      ...
      <div className="w-full bg-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-gray-700">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">Scope and Definitions</h2>
              <p className="text-justify">
            ...
            {/* Purpose */}
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-blue-900 mt-8 mb-4">Purpose of This Privacy Notice</h2>
              <p className="text-justify">
            ...
            {/* Section 1 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">1. WHAT INFORMATION DO WE COLLECT?</h2>
            ...
            {/* Section 2 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">2. HOW DO WE USE YOUR INFORMATION?</h2>
              <p className="text-justify font-semibold text-gray-900">
            ...
            {/* Section 3 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h2>
              <p className="text-justify font-semibold text-gray-900">
            ...
            {/* Section 4 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">4. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
              <p className="text-justify font-semibold text-gray-900">
            ...
            {/* Section 5 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">5. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
              <p className="text-justify font-semibold text-gray-900">
            ...
            {/* Section 6 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">6. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
              <p className="text-justify font-semibold text-gray-900">
            ...
            {/* Section 7 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">7. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
              <p className="text-justify">
            ...
            {/* Section 8 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">8. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
              <p className="text-justify font-semibold text-gray-900">
            ...
            {/* Section 9 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">9. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
              <p className="text-justify">
            ...
            {/* Section 10 */}
            <div className="space-y-4 mt-8">
              <h2 className="text-2xl font-bold text-blue-900 mb-4">10. HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
              <p className="text-justify">
